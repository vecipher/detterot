...
fn setup_director(
    ...
    state.pp_total = i32::from(context.pp.0);
    state.basis_overlay_bp = 0;
...
fn finalize_leg(
    ...
    state.pp_total = state
        .pp_total
        .saturating_add(i32::from(econ.pending_pp_delta));
    state.basis_overlay_bp = state
        .basis_overlay_bp
        .saturating_add(i32::from(econ.pending_basis_overlay_bp));
